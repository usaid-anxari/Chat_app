    ...
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="flex items-center gap-3 py-2 mx-4 border-b border-stone-500">
        ...
        <p className="flex-1 text-lg text-white flex items-center gap-2">
          Sadiq <span className="w-2 h-2 rounded-full bg-green-500"></span>
        </p>
        <img
        ...
        {messagesDummyData.map((msg, index) => (
          ...
          >
            ...
            <div className="text-center text-xs">
                  <img className="w-7 rounded-full" src={msg.senderId === '680f5116f10f3cd28382ed02' ? assets.avatar_icon : assets.profile_martin} alt="senderId" />
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3">
               <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full"> 
                ...
                <label htmlFor="image">
                  <img className="w-5 mr-2 cursor-pointer" src={assets.gallery_icon} alt="gallery_icon" />
                </label>
                </div>
                <img className="w-7 cursor-pointer" src={assets.send_button} alt="send_button" />
      </div>
    </div>
  ) : (
    <div className="flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden ">
      <img className="max-w-16" src={assets.logo_icon} alt="logo_icon" />
